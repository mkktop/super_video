...
.arrow, .out { color: var(--sv-text-dim); font-size: 13px; white-space: nowrap; }
...
.f-thumb.on { border-color: var(--sv-accent); box-shadow: 0 0 10px rgba(var(--sv-accent-rgb), 0.35); }
.f-thumb img {
  width: 100%;
  height: 100%;
  object-fit: cover;
...
.strip-note { font-size: 12px; color: var(--sv-text-dim); }
